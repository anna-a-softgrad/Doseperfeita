...
Partial Class Upsell
    ...
    Protected Sub ProductsVanila_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ProductsVanila.Click
        Sale(ProductsVanila.salePackageID)
    End Sub

    Protected Sub ProductsChocolate_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ProductsChocolate.Click
        Sale(ProductsChocolate.salePackageID)
    End Sub

    Protected Sub Sale(ByVal packageID As Integer)

        objVisitor.packagedealID = packageID
